...
from views.FOIL.foil_model import FoilImageClassifier
import numpy as np
# Medical
from views.FOIL.model_label.medical_foil_for_vscode import neg_FOIL as med_foil
from views.FOIL.model_label.medical_label_for_vscode import neg_label as med_label
# Bird
from views.FOIL.model_label.bird_foil_for_vscode import neg_FOIL as bird_foil
from views.FOIL.model_label.bird_label_for_vscode import neg_label as bird_label
# Defaultfrom views.FOIL.model_label.foil_neg_nocolor_newD import neg_FOIL as default_foil
from views.FOIL.model_label.foil_neg_nocolor_newD import neg_FOIL as default_foil
from views.FOIL.model_label.label_neg_nocolor import neg_label as default_label
...
def query(al_type, X_init, y_init, X_pool, n_instances=10, strategy=defualt_strategy, **kwargs):
    ...
    if al_type == 'Medical':
        ...
        fn_FOIL = default_foil
        fn_label = default_label
