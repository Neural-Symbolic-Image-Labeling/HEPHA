...
from views.FOIL.foil_model import FoilBase
from views.FOIL.foil_types import FoilXItem
...
""" Informativeness """
def informativeness_query_strategy_2(mode, classifier: ActiveLearner, X: FoilXItem, n_instances: int = 1) -> np.ndarray:
    X_satis_list = []
